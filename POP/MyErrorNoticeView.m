...
//  Dr. Dizzy
//
//  Created by confiz-2299 on 12/03/2015.
//  Copyright (c) 2015 Nawal Khalid. All rights reserved.
//
...
#define FontFamily @"Bahij Myriad Arabic"
#define FontFamilyBold @"Bahij Myriad Arabic-bold"
#define HeaderFontFamily @"MO_Nawel"
#define FontFamilyEN @"Calibri"
#define FontFamilyBoldEN @"Calibri-bold"
#define kFontFamilyBoldEN @"HelveticaNeue-bold"
#define HeaderFontFamilyNew @"CoconNextArabic-Light"
#define FONT_SIZE_STANDARD 20.0f
#define FontFamily @"Bahij Myriad Arabic"
@implementation MyErrorNoticeView

+ (MyErrorNoticeView *)errorNoticeInView:(UIView *)view title:(NSString *)title message:(NSString *)message
{
...
- (void)show
{
    ...
    if (true)
    {
        ...
        self.titleLabel.font = [UIFont fontWithName:FontFamilyBold size:14.0]; ;

        
         self.messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(15 , 20.0 + 10.0 + (self.contentInset.top), viewWidth-110, 12.0)];
        self.messageLabel.textAlignment = NSTextAlignmentRight ;
        self.messageLabel.font = [UIFont fontWithName:FontFamily size:13.0] ;
